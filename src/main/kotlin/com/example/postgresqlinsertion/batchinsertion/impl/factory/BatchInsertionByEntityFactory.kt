...
abstract class BatchInsertionByEntityFactory<E: BaseEntity>(
    ...
    override fun getSaver(type: SaverType): BatchInsertionByEntitySaver<E> {
        ...
        return when (type) {
            ...
            SaverType.INSERT_BASIC -> InsertByEntityBasicSaver(processor, entityClass, conn, batchSize)
            SaverType.INSERT -> InsertByEntitySaver(processor, entityClass, conn, batchSize)
            SaverType.INSERT_PREPARED_STATEMENT_BASIC -> InsertByEntityPSBasicSaver(processor, entityClass, conn, batchSize)
