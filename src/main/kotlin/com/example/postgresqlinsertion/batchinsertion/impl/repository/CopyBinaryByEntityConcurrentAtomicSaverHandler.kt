...
import com.example.postgresqlinsertion.batchinsertion.impl.saver.CopyBinaryByEntityConcurrentAtomicSaver
...
class CopyBinaryByEntityConcurrentAtomicSaverHandler<E : BaseEntity>(
    ...
    private val savers = (1..numberOfSavers)
        .map {
            ...
            CopyBinaryByEntityConcurrentAtomicSaver(processor, entityClass, conn, batchSize, executorService, UUID.randomUUID())
        }
